...
class Ui_PhotoProcessingWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Slider.setGeometry(QtCore.QRect(10, 610, 981, 31))
        ...
        self.a43 = QtWidgets.QAction(MainWindow)
        self.a43.setObjectName("a43")
        self.a169 = QtWidgets.QAction(MainWindow)
        self.a169.setObjectName("a169")
        self.a34 = QtWidgets.QAction(MainWindow)
        self.a34.setObjectName("a34")
        self.action9_17 = QtWidgets.QAction(MainWindow)
        self.action9_17.setObjectName("action9_17")
        self.a32 = QtWidgets.QAction(MainWindow)
        ...
        self.aFlipHor = QtWidgets.QAction(MainWindow)
        self.aFlipHor.setObjectName("aFlipHor")
        self.aFlipVert = QtWidgets.QAction(MainWindow)
        self.aFlipVert.setObjectName("aFlipVert")
        ...
        self.gray_skale = QtWidgets.QAction(MainWindow)
        self.gray_skale.setObjectName("gray_skale")
        self.acontrast = QtWidgets.QAction(MainWindow)
        self.acontrast.setObjectName("acontrast")
        self.a11 = QtWidgets.QAction(MainWindow)
        self.a11.setObjectName("a11")
        self.a23 = QtWidgets.QAction(MainWindow)
        ...
        self.menuFilters.addAction(self.gray_skale)
        self.menuFilters.addAction(self.acontrast)
        self.menuFilters.addAction(self.menuJust_Blue.menuAction())
        self.menuFilters.addAction(self.actionCurvies)
        self.menuAspect_Ratio.addAction(self.a11)
        self.menuAspect_Ratio.addAction(self.a23)
        self.menuAspect_Ratio.addAction(self.a32)
        self.menuAspect_Ratio.addAction(self.a34)
        self.menuAspect_Ratio.addAction(self.a43)
        self.menuAspect_Ratio.addAction(self.a169)
        ...
        self.menuRotation.addAction(self.aFlipHor)
        self.menuRotation.addAction(self.aFlipVert)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.a43.setText(_translate("MainWindow", "4:3"))
        self.a169.setText(_translate("MainWindow", "16:9"))
        self.a34.setText(_translate("MainWindow", "3:4"))
        self.action9_17.setText(_translate("MainWindow", "9:16"))
        self.a32.setText(_translate("MainWindow", "3:2"))
        ...
        self.aFlipHor.setText(_translate("MainWindow", "Flip Horizontally"))
        self.aFlipVert.setText(_translate("MainWindow", "Flip Vertically"))
        ...
        self.actionCurvies.setText(_translate("MainWindow", "Inbright like Curves"))
        self.BnW.setText(_translate("MainWindow", "Black\'n\'White"))
        self.All.setText(_translate("MainWindow", "All"))
        self.gray_skale.setText(_translate("MainWindow", "Gray Scale"))
        self.acontrast.setText(_translate("MainWindow", "Contrast"))
        self.a11.setText(_translate("MainWindow", "1:1"))
        self.a23.setText(_translate("MainWindow", "2:3"))
